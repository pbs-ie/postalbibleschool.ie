...
<div style="display:flex;justify-content:center;align-items:center; width:100%;height:90vh;">
    <div style="display: flex; flex-direction: column; align-items: center;">
        <a href="/"
            ...
            aria-label="logo">
            <img src="{{ asset('favicon.png') }}" alt="PBS Icon" style="width: 5rem;height:5rem" />
            <p style="text-transform: uppercase; font-weight: 600">Postal Bible School</p>
        </a>
        ...
        <a href="/"
            ...
            className="inline-block px-8 py-3 text-sm font-semibold text-center text-gray-500 transition duration-100 bg-gray-200 rounded-lg outline-none hover:bg-gray-300 focus-visible:ring ring-indigo-300 active:text-gray-700 md:text-base">Go home</a>
    </div>
