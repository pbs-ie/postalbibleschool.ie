    ...
    return (
        <div className="flex-none">
            <div className="inline-flex flex-col items-center gap-2 p-2 py-4 overflow-hidden text-gray-700 rounded-lg md:p-4 drop-shadow-lg min-h-content w-fit bg-stone-100">
                <img src={imageLink ? route('images.show', imageLink) : PlaceholderImage} alt={"Assembly thumbnail " + idx} className="object-cover object-center h-64 md:h-96 w-full rounded aspect-[4/3]" />
