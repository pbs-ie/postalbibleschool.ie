...
export default function OrderInfoCard({ schoolName, email, level0Order, level1Order, level2Order, level3Order, level4Order, tlpOrder, contactName }: Omit<LessonOrder, "id" | "fmRecordId" | "address" | "schoolType">) {
