...
import CreateClassroom from "@/Pages/Forms/CreateClassroom";
...
export default function CreateDialogCard({ onClose, innerRef = null }: ModalProps) {
    ...
    return (
        <dialog onKeyDown={handleKeyDown} ref={innerRef} className="relative z-10 px-5 pt-10 pb-5 mx-auto bg-white border-2 rounded backdrop:bg-gray-800/50 md:w-1/3 min-w-96 h-fit">
            ...
            <div className="mx-3 text-left">
                ...
                <CreateClassroom onCancel={() => handleCloseModal()} />
            </div>
        </dialog >
    )
}