...
export default function StepEventCard({ id, heading, image, description, date, showDetails = false }: EventCardProps) {
    return (
        <div className="flex flex-col items-center justify-between gap-2 p-4 border-2 rounded-lg bg-stone-100 drop-shadow-md">
            ...
            <img className="object-cover aspect-video" src={image ? image : PlaceholderImage} alt={"STEP card thumbnail for " + heading} />
