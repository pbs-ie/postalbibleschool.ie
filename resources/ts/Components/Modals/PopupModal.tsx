...
export default function PopupModal({ onClose, innerRef = null, size = "base", children }: ModalProps) {
    ...
    return (
        <dialog onKeyDown={handleKeyDown} ref={innerRef} className={"relative z-10 px-5 pt-10 pb-5 mx-auto bg-white border-2 rounded backdrop:bg-gray-800/50 w-full min-w-fit h-fit overflow-clip " + "md:" + getSizeCss()}>
