export default function LessonDownloadButton({ title, infoText, infoClass, getDownloadLink }: {title: string, infoText: string|null, infoClass: string, getDownloadLink: string}) {
    return (
        <>
            {infoText &&
