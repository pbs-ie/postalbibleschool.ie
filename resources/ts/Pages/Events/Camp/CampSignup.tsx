...
export default function Signup({ campSettings }: { campSettings: CampSettingProps }) {
    return (
        <CampWrapper title="Signup">
            ...
            <EventWrapper title={"Camp Registration"} className="bg-white bg-opacity-90">
                <ParagraphContainer>
                    ...
                    <ul className="mb-5 ml-5 text-left list-disc">
                        <li>The age limit of 10 or over by the 1st January, {campSettings.year} will strictly apply. Campers should not be over 17 years old by the end of camp.</li>
                        <li>Places are only available for those who are, and have been, regularly returning PBS lessons for the year {campSettings.year}</li>
                ...
                <div className="flex items-stretch justify-center p-2 my-10 md:p-0">
                    <iframe className="w-full md:w-3/4 max-w-7xl h-[35rem]" src={campSettings.embedLink}>Loading…</iframe>
                </div>
