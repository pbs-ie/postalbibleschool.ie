    ...
    return (
        <WrapperLayout>
            <ContentWrapper title="About Us">
                ...
                <Paragraph>Postal Bible School is a registered charity in Ireland and is closely linked with the work of BES (Bible Education Services) which grew out of the same seed work and now connects it to other PBS centres across the world.</Paragraph>
