                            ...
                            {!isButtonDisabled &&
                                <div className={"w-full lg:max-w-2xl"}>
                                    ...
                                    <div className="py-4 lg:px-8">
                                        <PaypalCheckoutButtons setSuccess={setIsSuccess} setErrorMessage={setError} onClick={handlePaymentContinued} cart={cartState} cartDescription="Payment for PBS Camp" />
                                    </div>
                                </div>
                            }
                            <div className="w-full lg:max-w-2xl">
