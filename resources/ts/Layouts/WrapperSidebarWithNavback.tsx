...
export default function WrapperSidebarWithNavback({ title, navBackText, navBackRoute, canEdit = false, children }: { title: string, navBackText?: string, navBackRoute?: string, canEdit?: boolean, children: React.ReactNode }) {
    return (
        <WrapperLayout>
            <SidebarLayout>
