...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `fm_schools`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_schools` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `migrations` VALUES (39,'2024_11_08_113558_rename_fm_schools_from_fm_school_details',6);
INSERT INTO `migrations` VALUES (40,'2024_11_13_100514_add_column_active_to_fm_students',7);
